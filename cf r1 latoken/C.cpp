...
ll dfs(int start,int parent)
{
	...
	{
		return dfs(parent,graph[parent][0]);
...
for(int i=0;i<n;i++)
{
	if(!visited[arr[i]]&&!visited[arr2[i]]){
	cnt+=dfs(arr[i],arr2[i]);
ans++;
